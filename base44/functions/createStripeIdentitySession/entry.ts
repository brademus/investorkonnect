...
Deno.serve(async (req) => {
  try {
    ...
    const BYPASS_EMAILS = ['bryceheller922+gnuren@gmail.com', 'bryceheller922+skdukjnsu@gmail.com', 'bryceheller922+sfeessdf@gmail.com', 'bryceheller922+qedcsdw@gmail.com'];
