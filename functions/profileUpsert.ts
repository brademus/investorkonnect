...
Deno.serve(async (req) => {
  try {
    ...
    const profileData = {
      ...
      user_type: body.role || body.user_type || body.user_role || profile.user_type || null,
      user_role: body.user_role || body.role || body.user_type || profile.user_role || null,
      company: body.company || null,
      phone: body.phone || null,
      market: body.market || null,
      markets: body.markets || profile.markets || [],
      target_state: body.target_state || profile.target_state || null,
      accreditation: body.accreditation || null,
      goals: body.goals || "",
      onboarding_step: body.onboarding_step || profile.onboarding_step || null,
