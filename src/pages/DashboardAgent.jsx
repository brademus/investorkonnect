        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
              ...
              <div className="bg-[#1F1C19] border border-[#38342F] rounded-3xl p-6 hover:shadow-[0_10px_25px_rgba(201,169,97,0.2)] hover:border-[#C9A961] transition-all">
                ...
                <Button 
                  ...
                  className="w-full bg-gradient-to-r from-[#C9A961] to-[#B8941F] hover:from-[#D4AF37] hover:to-[#C9A961] text-[#151311] rounded-full"
                >
              ...
              <div className="bg-[#1F1C19] border border-[#38342F] rounded-3xl p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 bg-[#C9A961]/20 rounded-xl flex items-center justify-center">
                    <TrendingUp className="w-6 h-6 text-[#C9A961]" />
                  </div>
                  <Link to={createPageUrl("MyProfile")} className="text-sm text-[#C9A961] hover:underline">
                    View profile →
                  </Link>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-[#C9A961]/20 rounded-lg border border-[#C9A961]/30">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-[#C9A961] rounded-lg flex items-center justify-center">
                        <Eye className="w-4 h-4 text-[#151311]" />
                      </div>
                      <span className="font-medium text-[#FAFAFA]">Profile Views</span>
                    </div>
                    <span className="text-xl font-bold text-[#C9A961]">{userData.profileViews}</span>
                  </div>
                  
                  <div className="flex items-center justify-between p-3 bg-[#292521] rounded-lg border border-[#38342F]">
                    <div className="flex items-center gap-3">
                    ...
                    <span className="text-xl font-bold text-[#9E9E9E]">{userData.activeClients}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-[#34D399]/20 rounded-lg border border-[#34D399]/30">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-[#34D399] rounded-lg flex items-center justify-center">
                        <TrendingUp className="w-4 h-4 text-[#151311]" />
                      </div>
              ...
              <div className="bg-[#1F1C19] border border-[#38342F] rounded-3xl p-6">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <Link to={createPageUrl("DealRooms")} className="text-sm text-[#C9A961] hover:underline">
                    View all →
                  </Link>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 rounded-lg border border-[#38342F] hover:border-[#DB2777] hover:bg-[#292521] transition-all">
                    <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center justify-between p-3 rounded-lg border border-[#38342F] hover:border-[#C9A961] hover:bg-[#292521] transition-all">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-[#C9A961]/20 rounded-full flex items-center justify-center">
                        <Users className="w-4 h-4 text-[#C9A961]" />
                      </div>
                      <span className="font-medium text-[#FAFAFA]">Pending Requests</span>
                    </div>
                    <span className="text-xl font-bold text-[#C9A961]">{userData.pendingRequests}</span>
                  </div>
                </div>
                ...
                <Button 
                  ...
                  variant="outline"
                  className="w-full mt-4 border-[#C9A961] text-[#C9A961] hover:bg-[#C9A961]/10"
                >
                  Open Deal Rooms
                </Button>
              </div>
              ...
              <div className="bg-[#1F1C19] border border-[#38342F] rounded-3xl p-6">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <Link to={createPageUrl("AccountProfile")} className="text-sm text-[#C9A961] hover:underline">
                    Edit →
                  </Link>
                </div>
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-[#292521] rounded-xl border border-[#38342F]">
                    <p className="text-xs text-[#9E9E9E] uppercase tracking-wide mb-1">Primary Markets</p>
                  ...
                  <div className="p-4 bg-[#292521] rounded-xl border border-[#38342F]">
                    <p className="text-xs text-[#9E9E9E] uppercase tracking-wide mb-1">Experience</p>
                    <p className="font-semibold text-[#FAFAFA]">
                  ...
                  <div className="p-4 bg-[#292521] rounded-xl border border-[#38342F]">
                    <p className="text-xs text-[#9E9E9E] uppercase tracking-wide mb-1">Specialties</p>
                    <p className="font-semibold text-[#FAFAFA]">
              ...
              {[
                ...
                return (
                  <Link 
                    ...
                    className="bg-[#1F1C19] border border-[#38342F] rounded-xl flex items-center gap-3 p-4 hover:border-[#C9A961] hover:bg-[#292521] transition-all"
                  >
