...
import { 
  Users, Eye, TrendingUp, Mail, MessageCircle, Folder, 
  User, DollarSign, BookOpen, ArrowRight, Home as HomeIcon, Shield
} from "lucide-react";
...
function AgentDashboardContent() {
  ...
  // Stat cards data (Agent-specific)
  const statCards = [
    { icon: Users, value: stats.connectionRequests, label: "Connection Requests", trend: "+5% this week", trendPositive: true, bgColor: "bg-blue-100", iconColor: "text-blue-600" },
    { icon: Eye, value: stats.profileViews, label: "Profile Views", trend: "+15% this week", trendPositive: true, bgColor: "bg-[#D4AF37]/20", iconColor: "text-[#D4AF37]" },
    { icon: TrendingUp, value: stats.activeInvestors, label: "Active Investors", trend: "+3% this week", trendPositive: true, bgColor: "bg-purple-100", iconColor: "text-purple-600" },
  ...
  // Quick action cards data (Agent-specific)
  const quickActions = [
    ...
    { title: "Browse Investors", description: "Find investors looking for agents", icon: Users, bgColor: "bg-amber-100", iconColor: "text-amber-600", href: createPageUrl("InvestorDirectory") },
    ...
    { title: "Profile Settings", description: "Update your agent profile", icon: User, bgColor: "bg-emerald-100", iconColor: "text-emerald-600", href: createPageUrl("MyProfile") },
    { title: "Earnings", description: "View your earnings and payouts", icon: DollarSign, bgColor: "bg-amber-100", iconColor: "text-amber-700", href: createPageUrl("Billing") },
  ...
  // Sample recent investor connections (placeholder)
  const recentConnections = [
    { name: "Alex Thompson", location: "Phoenix, AZ" },
    { name: "Jordan Lee", location: "Dallas, TX" },
    { name: "Morgan Smith", location: "Atlanta, GA" }
  ];

  // Sample upcoming meetings (placeholder)
  const upcomingMeetings = [
    { text: "Call with investor Alex", due: "Today, 2:00 PM" },
    { text: "Property showing", due: "Tomorrow, 10:00 AM" },
    { text: "Deal review meeting", due: "Friday, 3:00 PM" }
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-white pt-12 pb-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-[16px] text-[#666666]">Here's what's happening with your investor connections today</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 bg-white border border-[#E5E5E5] rounded-2xl p-6" style={{ boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
              <h3 className="text-[18px] font-bold text-black mb-4">Upcoming Meetings</h3>
                ...
                {upcomingMeetings.map((meeting, idx) => (
                  <div key={idx} className="flex items-center justify-between p-3 hover:bg-[#F9F9F9] rounded-lg transition-colors cursor-pointer">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[14px] text-[#333333]">{meeting.text}</span>
                    </div>
                    <span className="text-[12px] text-[#666666]">{meeting.due}</span>
                  </div>
                ))}
              </div>
            </div>
