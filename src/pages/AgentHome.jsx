            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-orange-800 mb-4">
                  Sign our NDA to access investor profiles and secure deal rooms. This protects all confidential information shared on the platform.
                </p>
        ...
        {!isVerified && (
          <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 mb-8">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-blue-900 mb-2">Complete Verification</h3>
