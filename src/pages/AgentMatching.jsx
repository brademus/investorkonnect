...
export default function AgentMatching() {
  ...
  const handleSelectAgent = async (agentMatch) => {
    ...
    try {
      // Save agent selection to Deal and sessionStorage ONLY
      // Do NOT create Room yet - that happens after investor signs
      ...
      toast.error("Failed to select agent: " + error.message);
