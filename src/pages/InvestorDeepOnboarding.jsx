...
export default function InvestorDeepOnboarding() {
    ...
    <div>
      ...
      <div className="space-y-5">
        <div>
          ...
          <Input value={formData.full_name} onChange={(e) => updateField('full_name', e.target.value)} className="h-12 mt-1" />
        </div>
        <div>
          <Label>Phone *</Label>
          <Input type="tel" value={formData.phone} onChange={(e) => updateField('phone', e.target.value)} className="h-12 mt-1" />
        </div>
        <div>
          <Label>Company (optional)</Label>
          <Input value={formData.company} onChange={(e) => updateField('company', e.target.value)} className="h-12 mt-1" />
        </div>
      </div>
    </div>
  );
      ...
      <div className="space-y-5">
        <div>
          ...
          <RadioGroup value={formData.investor_description} onValueChange={(v) => updateField('investor_description', v)} className="mt-2 space-y-2">
            <div className="flex items-center gap-2"><RadioGroupItem value="new" id="new" /><Label htmlFor="new" className="font-normal">New investor (0 deals)</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="few_deals" id="few" /><Label htmlFor="few" className="font-normal">Have done a few deals</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="experienced" id="exp" /><Label htmlFor="exp" className="font-normal">Experienced (10+ deals)</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="professional" id="pro" /><Label htmlFor="pro" className="font-normal">Professional/Institutional</Label></div>
          </RadioGroup>
        </div>
        <div>
          <Label>Deals closed in last 24 months</Label>
          <RadioGroup value={formData.deals_closed_24mo} onValueChange={(v) => updateField('deals_closed_24mo', v)} className="mt-2 space-y-2">
            <div className="flex items-center gap-2"><RadioGroupItem value="0" id="d0" /><Label htmlFor="d0" className="font-normal">0</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="1_2" id="d12" /><Label htmlFor="d12" className="font-normal">1-2</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="3_5" id="d35" /><Label htmlFor="d35" className="font-normal">3-5</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="6_plus" id="d6" /><Label htmlFor="d6" className="font-normal">6+</Label></div>
          </RadioGroup>
        </div>
        <div>
          ...
          <RadioGroup value={formData.accredited_investor} onValueChange={(v) => updateField('accredited_investor', v)} className="mt-2 space-y-2">
            <div className="flex items-center gap-2"><RadioGroupItem value="yes" id="ay" /><Label htmlFor="ay" className="font-normal">Yes</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="no" id="an" /><Label htmlFor="an" className="font-normal">No</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="not_sure" id="ans" /><Label htmlFor="ans" className="font-normal">Not sure</Label></div>
          </RadioGroup>
        </div>
      </div>
    </div>
  ...
  const renderStep3 = () => (
    <div>
      ...
      <div className="space-y-5">
        <div>
          <Label>Capital available in next 12 months</Label>
          <RadioGroup value={formData.capital_available_12mo} onValueChange={(v) => updateField('capital_available_12mo', v)} className="mt-2 space-y-2">
            <div className="flex items-center gap-2"><RadioGroupItem value="under_50k" id="c1" /><Label htmlFor="c1" className="font-normal">Under $50K</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="50k_150k" id="c2" /><Label htmlFor="c2" className="font-normal">$50K - $150K</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="150k_300k" id="c3" /><Label htmlFor="c3" className="font-normal">$150K - $300K</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="300k_600k" id="c4" /><Label htmlFor="c4" className="font-normal">$300K - $600K</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="600k_plus" id="c5" /><Label htmlFor="c5" className="font-normal">$600K+</Label></div>
          </RadioGroup>
        </div>
        <div>
          <Label>Financing methods you use (select all)</Label>
          <div className="grid grid-cols-2 gap-2 mt-2">
            {FINANCING_METHODS.map(m => (
              <div key={m.value} className="flex items-center gap-2">
                ...
                <Label className="font-normal">{m.label}</Label>
              </div>
            ))}
          </div>
        </div>
        <div>
          <Label>Do you have financing lined up?</Label>
          <RadioGroup value={formData.financing_lined_up} onValueChange={(v) => updateField('financing_lined_up', v)} className="mt-2 space-y-2">
            <div className="flex items-center gap-2"><RadioGroupItem value="yes" id="fl1" /><Label htmlFor="fl1" className="font-normal">Yes</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="in_progress" id="fl2" /><Label htmlFor="fl2" className="font-normal">In progress</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="no" id="fl3" /><Label htmlFor="fl3" className="font-normal">No</Label></div>
          </RadioGroup>
        </div>
      </div>
    </div>
  ...
  const renderStep4 = () => (
    <div>
      ...
      <div className="space-y-5">
        <div>
          <Label>Investment strategies (select all)</Label>
          <div className="grid grid-cols-2 gap-2 mt-2">
        ...
        <div>
          <Label>Property types (select all)</Label>
          <div className="grid grid-cols-2 gap-2 mt-2">
        ...
        <div>
          <Label>Property condition preference</Label>
          <RadioGroup value={formData.property_condition} onValueChange={(v) => updateField('property_condition', v)} className="mt-2 space-y-2">
            <div className="flex items-center gap-2"><RadioGroupItem value="turnkey" id="pc1" /><Label htmlFor="pc1" className="font-normal">Turnkey</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="light_cosmetic" id="pc2" /><Label htmlFor="pc2" className="font-normal">Light cosmetic</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="heavy_rehab" id="pc3" /><Label htmlFor="pc3" className="font-normal">Heavy rehab</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="any" id="pc4" /><Label htmlFor="pc4" className="font-normal">Any condition</Label></div>
          </RadioGroup>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div className="space-y-5">
        <div>
          ...
          <select value={formData.primary_state} onChange={(e) => updateField('primary_state', e.target.value)} className="h-12 w-full rounded-lg border border-[#E5E5E5] px-4 mt-1">
            <option value="">Select state</option>
            {US_STATES.map(s => <option key={s} value={s}>{s}</option>)}
          </select>
        </div>
        <div>
          <Label>Specific cities or counties (optional)</Label>
          <Input value={formData.specific_cities_counties} onChange={(e) => updateField('specific_cities_counties', e.target.value)} placeholder="e.g., Austin, Dallas County" className="h-12 mt-1" />
        </div>
        <div>
          <Label>Price range (min)</Label>
          <Input type="number" value={formData.state_price_min} onChange={(e) => updateField('state_price_min', e.target.value)} placeholder="e.g., 100000" className="h-12 mt-1" />
        </div>
        <div>
          <Label>Price range (max)</Label>
          <Input type="number" value={formData.state_price_max} onChange={(e) => updateField('state_price_max', e.target.value)} placeholder="e.g., 500000" className="h-12 mt-1" />
        </div>
      </div>
    </div>
  );
  ...
  const renderStep6 = () => (
    <div>
      ...
      <div className="space-y-5">
        <div>
          <Label>Deal types open to (select all)</Label>
          <div className="grid grid-cols-2 gap-2 mt-2">
            {[
              ...
              <div key={d.value} className="flex items-center gap-2">
                ...
                <Label className="font-normal">{d.label}</Label>
              </div>
            ))}
          </div>
        </div>
        <div>
          ...
          <RadioGroup value={formData.most_important_now} onValueChange={(v) => updateField('most_important_now', v)} className="mt-2 space-y-2">
            <div className="flex items-center gap-2"><RadioGroupItem value="cash_flow" id="mi1" /><Label htmlFor="mi1" className="font-normal">Cash flow</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="appreciation" id="mi2" /><Label htmlFor="mi2" className="font-normal">Appreciation</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="quick_flip" id="mi3" /><Label htmlFor="mi3" className="font-normal">Quick flip profit</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="tax_benefits" id="mi4" /><Label htmlFor="mi4" className="font-normal">Tax benefits</Label></div>
          </RadioGroup>
        </div>
        <div>
          ...
          <RadioGroup value={formData.target_hold_period} onValueChange={(v) => updateField('target_hold_period', v)} className="mt-2 space-y-2">
            <div className="flex items-center gap-2"><RadioGroupItem value="under_1y" id="hp1" /><Label htmlFor="hp1" className="font-normal">Under 1 year</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="1_3y" id="hp2" /><Label htmlFor="hp2" className="font-normal">1-3 years</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="3_7y" id="hp3" /><Label htmlFor="hp3" className="font-normal">3-7 years</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="7_plus" id="hp4" /><Label htmlFor="hp4" className="font-normal">7+ years</Label></div>
          </RadioGroup>
        </div>
      </div>
    </div>
  ...
  const renderStep7 = () => (
    <div>
      ...
      <div className="space-y-5">
        <div>
          <Label>Decision speed on a deal</Label>
          <RadioGroup value={formData.decision_speed_on_deal} onValueChange={(v) => updateField('decision_speed_on_deal', v)} className="mt-2 space-y-2">
            <div className="flex items-center gap-2"><RadioGroupItem value="same_day" id="ds1" /><Label htmlFor="ds1" className="font-normal">Same day</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="2_3_days" id="ds2" /><Label htmlFor="ds2" className="font-normal">2-3 days</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="1_week" id="ds3" /><Label htmlFor="ds3" className="font-normal">1 week</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="2_weeks_plus" id="ds4" /><Label htmlFor="ds4" className="font-normal">2+ weeks</Label></div>
          </RadioGroup>
        </div>
        <div>
          <Label>Typical earnest money %</Label>
          <Input value={formData.typical_earnest_money_pct} onChange={(e) => updateField('typical_earnest_money_pct', e.target.value)} placeholder="e.g., 1-3%" className="h-12 mt-1" />
        </div>
        <div>
          <Label>Comfortable with non-refundable earnest money?</Label>
          <RadioGroup value={formData.comfortable_non_refundable_em} onValueChange={(v) => updateField('comfortable_non_refundable_em', v)} className="mt-2 space-y-2">
            <div className="flex items-center gap-2"><RadioGroupItem value="yes" id="em1" /><Label htmlFor="em1" className="font-normal">Yes</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="no" id="em2" /><Label htmlFor="em2" className="font-normal">No</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="depends" id="em3" /><Label htmlFor="em3" className="font-normal">Depends on the deal</Label></div>
          </RadioGroup>
        </div>
        <div>
          <Label>Tell us about your most recent deal (optional)</Label>
          <Textarea value={formData.most_recent_deal} onChange={(e) => updateField('most_recent_deal', e.target.value)} placeholder="Brief description..." rows={3} className="mt-1" />
        </div>
      </div>
    </div>
  );
  ...
  const renderStep8 = () => (
    <div>
      ...
      <div className="space-y-5">
        <div>
          <Label>What do you want from an agent? (select all)</Label>
          <div className="grid grid-cols-1 gap-2 mt-2">
            {[
              ...
              <div key={w.value} className="flex items-center gap-2">
                ...
                <Label className="font-normal">{w.label}</Label>
              </div>
            ))}
          </div>
        </div>
        <div>
          <Label>Preferred communication (select all)</Label>
          <div className="grid grid-cols-2 gap-2 mt-2">
        ...
        <div>
          <Label>Preferred agent response time</Label>
          <RadioGroup value={formData.preferred_agent_response_time} onValueChange={(v) => updateField('preferred_agent_response_time', v)} className="mt-2 space-y-2">
            <div className="flex items-center gap-2"><RadioGroupItem value="asap" id="rt1" /><Label htmlFor="rt1" className="font-normal">ASAP (within hours)</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="24_hours" id="rt2" /><Label htmlFor="rt2" className="font-normal">Within 24 hours</Label></div>
            <div className="flex items-center gap-2"><RadioGroupItem value="48_hours" id="rt3" /><Label htmlFor="rt3" className="font-normal">Within 48 hours</Label></div>
          </RadioGroup>
        </div>
        <div>
          <Label>Agent deal breakers (optional)</Label>
          <Textarea value={formData.agent_deal_breakers} onChange={(e) => updateField('agent_deal_breakers', e.target.value)} placeholder="What would make you NOT work with an agent?" rows={2} className="mt-1" />
        </div>
        <div>
          <Label>Anything else agents should know?</Label>
