      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#0D0D0D] border border-[#1F1F1F] rounded-2xl p-8 md:p-12">
          ...
          <div className="prose prose-invert prose-sm max-w-none space-y-6 text-[#FAFAFA]">
            ...
            <p>We may require identity verification before granting full access to Platform features. Verification is currently performed through Stripe Identity, a third-party identity verification service operated by Stripe, Inc. During verification you may be asked to submit a photo of a government-issued ID and a live selfie image. By submitting verification information, you consent to that information being processed by Stripe in accordance with Stripe's terms and privacy policy, and to our receipt of the verification result. We reserve the right to change identity verification providers at our discretion; if we do, we will update this section and our Privacy Policy accordingly.</p>
