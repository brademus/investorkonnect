      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="rounded-[16px] p-6 backdrop-blur-sm" style={{ background: 'linear-gradient(180deg, rgba(23,23,27,0.92) 0%, rgba(17,17,20,0.96) 100%)', border: '1px solid rgba(255,255,255,0.06)', boxShadow: '0 8px 30px rgba(0,0,0,0.6)' }}>
