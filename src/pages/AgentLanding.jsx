...
export default function AgentLanding() {
  ...
  return (
    <div className="min-h-screen bg-transparent">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#0D0D0D] border border-[#1F1F1F] rounded-2xl p-6">
              <div className="bg-[#0D0D0D] mb-4 rounded-full w-12 h-12 flex items-center justify-center">
                <Briefcase className="text-[#E3C567] lucide lucide-briefcase w-6 h-6" />
              </div>
      ...
      {/* Stats Section */}
      <section className="py-16 px-4 bg-[#0D0D0D]/50">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-[#E3C567] mb-2">500+</div>
              <div className="text-[#808080]">Active Investors</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[#E3C567] mb-2">$2.5B+</div>
              <div className="text-[#808080]">In Deal Volume</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-[#E3C567] mb-2">95%</div>
              <div className="text-[#808080]">Agent Satisfaction</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="flex gap-6 items-start">
              <div className="w-12 h-12 bg-[#E3C567] rounded-full flex items-center justify-center flex-shrink-0 text-black font-bold">
                1
              </div>
              <div>
                <h3 className="text-xl font-bold text-[#FAFAFA] mb-2">Create Your Profile</h3>
                <p className="text-[#808080]">
                  Showcase your investment property experience, specialties, markets, and track record. Our matching algorithm uses this to connect you with the right investors.
                </p>
              </div>
            </div>
            <div className="flex gap-6 items-start">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#FAFAFA] mb-2">Get Matched with Investors</h3>
                <p className="text-[#808080]">
                  Receive connection requests from investors actively looking for agents in your market. Review their criteria and accept deals that fit your practice.
                </p>
              </div>
            </div>
            <div className="flex gap-6 items-start">
              ...
              <div>
                <h3 className="text-xl font-bold text-[#FAFAFA] mb-2">Close More Deals</h3>
                <p className="text-[#808080]">
                  Use our platform to manage the entire deal lifecycle—from first contact to closing. Built-in chat, document sharing, and pipeline tracking keep everything organized.
                </p>
              </div>
            </div>
          </div>
