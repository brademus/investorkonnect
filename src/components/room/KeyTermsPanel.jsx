  ...
  useEffect(() => {
    ...
    const loadTerms = async () => {
      ...
      try {
        ...
        // Priority 1: AGENT-SPECIFIC terms from room.agent_terms[agentId] (set by counter offer acceptance)
        ...
        // Priority 2: Room.proposed_terms (original deal terms shared by all agents)
